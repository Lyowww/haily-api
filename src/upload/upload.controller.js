...
var UploadController = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    if (!file.buffer || file.buffer.length === 0 || file.size === 0) {
                        throw new common_1.BadRequestException('Uploaded file is empty (0 bytes). Ensure your client sends a real multipart/form-data file. If you use React Native/Expo, do NOT manually set the Content-Type header; let fetch/axios set the boundary.');
                    }
                    return [2 /*return*/, this.uploadService.uploadFile(file)];
                });
            });
        };
    ...
    (function () {
        ...
        _uploadFile_decorators = [(0, common_1.Post)(), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
            ...
            })), (0, swagger_1.ApiOperation)({ summary: 'Upload an image file' }), (0, swagger_1.ApiConsumes)('multipart/form-data'), (0, swagger_1.ApiBody)({
                schema: {
                    type: 'object',
                    properties: {
                        file: {
            ...
            }), (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid file or validation error' }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' })];
