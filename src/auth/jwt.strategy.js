...
var JwtStrategy = function () {
    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(configService, authService) {
        ...
        JwtStrategy_1.prototype.validate = function (payload) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.validateUser(payload.sub)];
                        case 1:
                            user = _a.sent();
                            if (!user) {
                            ...
                            return [2 /*return*/, __assign(__assign({}, user), { userId: user.id })];
                    }
                });
            });
        };
