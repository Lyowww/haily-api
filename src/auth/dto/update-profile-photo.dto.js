...
exports.UpdateProfilePhotoDto = void 0;
var class_validator_1 = require("class-validator");
var swagger_1 = require("@nestjs/swagger");
var UpdateProfilePhotoDto = function () {
    var _a;
    var _photoUrl_decorators;
    var _photoUrl_initializers = [];
    var _photoUrl_extraInitializers = [];
    return _a = /** @class */ (function () {
            function UpdateProfilePhotoDto() {
                this.photoUrl = __runInitializers(this, _photoUrl_initializers, void 0); // Definite assignment assertion - will be validated by class-validator
...
exports.UpdateProfilePhotoDto = UpdateProfilePhotoDto;
