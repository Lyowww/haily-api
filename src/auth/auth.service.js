    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.register = function (registerDto) {
            return __awaiter(this, void 0, void 0, function () {
                var email, password, existingUser, saltRounds, passwordHash, user, accessToken;
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!user.passwordHash) {
                                throw new common_1.BadRequestException('Account not set up with password. Please use magic link or reset password.');
                            }
        ...
        AuthService_1.prototype.updateProfilePhoto = function (userId, photoUrl) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        AuthService_1.prototype.updateProfile = function (userId, update) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.user.update({
                                where: { id: userId },
                                data: __assign(__assign(__assign({}, (update.sex !== undefined ? { sex: update.sex } : {})), (update.age !== undefined ? { age: update.age } : {})), (update.heightCm !== undefined ? { heightCm: update.heightCm } : {})),
                                select: {
                                    id: true,
                                    email: true,
                                    avatarBaseImageUrl: true,
        ...
        AuthService_1.prototype.changePassword = function (userId, currentPassword, newPassword) {
            return __awaiter(this, void 0, void 0, function () {
                var user, ok, saltRounds, passwordHash;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.user.findUnique({
                                where: { id: userId },
                        ...
                        case 1:
                            ...
                            if (!user)
                                throw new common_1.UnauthorizedException('User not found');
                            if (!user.passwordHash) {
                                throw new common_1.BadRequestException('Password is not set for this account');
                            }
                        ...
                        case 2:
                            ...
                            if (newPassword.length > 128) {
                                throw new common_1.BadRequestException('New password is too long');
                            }
