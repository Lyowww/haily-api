...
var AddWardrobeItemDto = function () {
    ...
    return _a = /** @class */ (function () {
            function AddWardrobeItemDto() {
                ...
                this.tags = (__runInitializers(this, _imageUrl_extraInitializers), __runInitializers(this, _tags_initializers, void 0));
        ...
        (function () {
            ...
            _tags_decorators = [(0, swagger_1.ApiProperty)({ required: false }), (0, class_validator_1.IsOptional)()];
...
var UpdateWardrobeItemDto = function () {
    ...
    return _a = /** @class */ (function () {
            function UpdateWardrobeItemDto() {
                this.seasonTags = __runInitializers(this, _seasonTags_initializers, void 0);
                __runInitializers(this, _seasonTags_extraInitializers);
            }
            return UpdateWardrobeItemDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _seasonTags_decorators = [(0, swagger_1.ApiProperty)({ required: false, type: [String] }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsArray)()];
...
var WardrobeController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Wardrobe'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.Controller)('wardrobe')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _addItem_decorators;
    var _getUserWardrobe_decorators;
    var _getByCategory_decorators;
    var _deleteItem_decorators;
    var _updateItem_decorators;
    var WardrobeController = _classThis = /** @class */ (function () {
        function WardrobeController_1(wardrobeService) {
            this.wardrobeService = (__runInitializers(this, _instanceExtraInitializers), wardrobeService);
        }
        WardrobeController_1.prototype.addItem = function (req, addItemDto) {
            return __awaiter(this, void 0, void 0, function () {
                var userId;
                return __generator(this, function (_a) {
                    userId = req.user.userId;
                    return [2 /*return*/, this.wardrobeService.addItem(userId, addItemDto.category, addItemDto.imageUrl, addItemDto.tags)];
                });
            });
        };
        WardrobeController_1.prototype.getUserWardrobe = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.wardrobeService.getUserWardrobe(req.user.userId)];
                });
            });
        };
        WardrobeController_1.prototype.getByCategory = function (req, category) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.wardrobeService.getItemsByCategory(req.user.userId, category)];
                });
            });
        };
        WardrobeController_1.prototype.deleteItem = function (req, id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.wardrobeService.deleteItem(req.user.userId, id)];
                });
            });
        };
        WardrobeController_1.prototype.updateItem = function (req, id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.wardrobeService.updateItem(req.user.userId, id, dto)];
                });
            });
        };
        return WardrobeController_1;
    }());
    __setFunctionName(_classThis, "WardrobeController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _addItem_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({ summary: 'Add item to wardrobe' }), (0, swagger_1.ApiResponse)({ status: 201, description: 'Item added successfully' })];
        _getUserWardrobe_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Get user wardrobe' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns user wardrobe items' })];
        _getByCategory_decorators = [(0, common_1.Get)('category/:category'), (0, swagger_1.ApiOperation)({ summary: 'Get wardrobe items by category' })];
        _deleteItem_decorators = [(0, common_1.Delete)(':id'), (0, swagger_1.ApiOperation)({ summary: 'Delete wardrobe item' })];
        _updateItem_decorators = [(0, common_1.Patch)(':id'), (0, swagger_1.ApiOperation)({ summary: 'Update wardrobe item (user overrides)' })];
        ...
        __esDecorate(_classThis, null, _getUserWardrobe_decorators, { kind: "method", name: "getUserWardrobe", static: false, private: false, access: { has: function (obj) { return "getUserWardrobe" in obj; }, get: function (obj) { return obj.getUserWardrobe; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        WardrobeController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return WardrobeController = _classThis;
}();
