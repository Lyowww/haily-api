...
exports.SendHelpCenterMessageDto = void 0;
var swagger_1 = require("@nestjs/swagger");
var class_validator_1 = require("class-validator");
var SendHelpCenterMessageDto = function () {
    var _a;
    var _text_decorators;
    var _text_initializers = [];
    var _text_extraInitializers = [];
    return _a = /** @class */ (function () {
            function SendHelpCenterMessageDto() {
                this.text = __runInitializers(this, _text_initializers, void 0);
                __runInitializers(this, _text_extraInitializers);
            }
            return SendHelpCenterMessageDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _text_decorators = [(0, swagger_1.ApiProperty)({ example: 'Hi! I need help with my subscription.' }), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(1), (0, class_validator_1.MaxLength)(2000)];
...
exports.SendHelpCenterMessageDto = SendHelpCenterMessageDto;
