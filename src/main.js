...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, allowedOrigins, express, swaggerConfig, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    console.log("\uD83D\uDE80 AI Outfit API is running on: http://localhost:".concat(port));
                    console.log("\uD83D\uDCDA Swagger docs available at: http://localhost:".concat(port, "/api/docs"));
                    console.log("\uD83C\uDF0D Environment: ".concat(configService.nodeEnv));
                    return [2 /*return*/];
            }
        });
    });
